  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      local servers = {
        ...
        gopls = {},
        pyright = {
          vim.keymap.set('i', '<C-k>', '<cmd>lua vim.lsp.buf.signature_help()<CR>', opts), -- Signature help in insert mode
        },
        -- rust_analyzer = {},
        -- ... etc. See `:help lspconfig-all` for a list of all the pre-configured LSPs
        --
        elixirls = {},
        ruff = {}, -- ruff server for linting, formatting
...
-- Defer to pyright for textDocument/hover
-- After the servers are initialized, add your autocmd
vim.api.nvim_create_autocmd('LspAttach', {
